...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "6BSgiySHnGwoCSk6WmHVlx8YYAnUVqQG";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		// Encode keyword in URL since it may contain specical characters
		if(keyword == null) {
		...
		try {
			// open a http connection between yout java application and ticketmaster based url
